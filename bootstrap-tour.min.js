 ...
 * ========================================================================
 * 
 * <div class="popover" role="tooltip" style="padding: 0.5%;"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="popbtn-group"> <button class="popbtn popbtn-sm popbtn-default" data-role="prev">&laquo; Prev</button> <button class="popbtn popbtn-sm popbtn-default" data-role="next">Next &raquo;</button> <button class="popbtn popbtn-sm popbtn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="popbtn popbtn-sm popbtn-default" data-role="end">End tour</button> </div> </div>
 <div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><i class="fa fa-close push-right header__opposite" data-role="end"></i>
    ...
    return n = e.document, o = function() {
        function o(o) {
            ...
            this._options = t.extend({
                ...
                delay: !1,
                basePath: "",
                template: '<div class="popover" role="tooltip" ><div class="arrow"></div><h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation text-center"><div class="btn-group"> <button type="button" class="popBtn popBtn-sm popBtn-default btn btn-success btn-sm" data-role="prev">&laquo; Prev</button> <button type="button" class="popBtn popBtn-sm popBtn-default btn btn-success btn-sm" data-role="next">Next &raquo;</button>&nbsp;<button type="button" class="popBtn popBtn-sm popBtn-default btn btn-success btn-sm" data-role="end">End tour</button></div></div></div>',
